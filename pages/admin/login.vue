...
<template>
	<div
		class="min-h-screen flex items-center justify-center bg-paper-cream p-4 text-ink antialiased"
	>
		<div
			class="w-full max-w-md bg-white rounded-xl shadow-subtle border border-ink-border p-8 space-y-6"
		>
			<div class="text-center space-y-2">
				<div
					class="w-12 h-12 bg-forest-900 text-gold-300 rounded-lg mx-auto flex items-center justify-center shadow"
				>
					<BookOpen :size="24" />
				</div>
				...
				<p class="text-xs text-ink-muted">
					Single Administrator Control Portal
				</p>
			</div>
			...
			<div
				class="text-center pt-2 border-t border-ink-border text-[11px] text-ink-muted"
			>
				<span>ebookreadsBookstore • Production Control Node</span>
			</div>
		</div>
	</div>
</template>
